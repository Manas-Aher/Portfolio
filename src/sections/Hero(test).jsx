...
const Hero = () => {
    ...
    useGSAP(() => {
        if (animationRef.current) return; // Prevent re-running animation on re-mounts
    ...
    <section id='hero' className='relative overflow-hidden'>
        <div className='hero-layout flex flex-col md:flex-row'>
                            ...
                            <span className='slide'>
                                <span className="wrapper">
                                    {words.map((word) => (
                                        ...
                                        <img src={word.imgPath} alt={word.text} className="xl:size-12 md:size-10 size-7 md:p-2 p-1 rounded-full bg-white-50" loading="lazy" />
                                        <span>{word.text}</span>
                                    </span>
                                    ))}
                                </span>
            ...
            <div className="w-full md:pr-20 pr-5 md:pt-20 pt-5 md:pb-20 pb-10 md:w-[45%] " >
                <img src="/images/Manas1.jpg" className="md:mb-30 mb-0 md:mt-20 mt-0 rounded-lg " loading="lazy" />
            </div>
        </div>
    </section>
